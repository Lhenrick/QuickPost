    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center h-auto min-h-screen w-screen px-2 py-5 bg-zinc-800 gap-5">
                ...
                <form className="flex">
                    <input onChange={handleSearch} placeholder="Search for a title" type="text" className=" w-9/12 sm:w-80 md:w-80 lg:w-96 lg:h-12 rounded-l-xl pl-3 text-white bg-zinc-900" />
