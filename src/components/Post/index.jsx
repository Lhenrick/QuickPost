...
export default function Post({data}) {
    ...
    return (
        <div className="flex flex-col w-full items-left min-h-56 sm:h-64 lg:w-full px-3 py-5 gap-2 bg-zinc-900 text-white border-solid border-2 rounded-xl border-yellow-400  shadow-xl shadow-black">
