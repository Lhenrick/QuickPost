    ...
    return (
        <section className="flex flex-col pb-5 bg-gradient-to-br from-yellow-300 via-neutral-800 to-neutral-900  min-h-screen h-auto items-center">
            ...
            <section className="mt-10 size-5/6 md:size-3/6">               
                    {post.length == 0 ? <h3 className="text-white text-center mb-3 font-bold text-2xl sm:text-4xl">You haven't posted anything yet 😒</h3> :
                    <h3 className="text-white text-center mb-3 font-bold text-2xl sm:text-4xl">Your QuickPosts</h3> }
